...
public interface MapboxService {
    ...
    Observable<DirectionsResponse> getDirections(@Path("profile") String profileType, @Path("coordinates") RouteCoordinates routeCoordinates, @Query("access_token") String accessToken);
